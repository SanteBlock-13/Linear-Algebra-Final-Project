...
def matrix_create(b_type, r1 = None, r2 = None, r3 = None, r4 = None, r5 = None): # Dynamically creates matrix based on values; b_type signifies whether b is a zero vector (0) or not (1)
